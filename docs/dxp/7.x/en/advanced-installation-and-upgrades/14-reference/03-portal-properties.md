...
> For more database configuration details, see [Connecting to a Database](../01-installing-liferay-dxp-on-premises/configuring-a-database.md) and [Database Templates](./05-database-templates.md).
