...
The Customer Portal identifies [fix packs](../installing-patches/patch-installation-overview.md) that are not revertible, and therefore ineligible for rolling restart. All other fix packs are eligible.
...
* [Installing Patches](../installing-patches/patch-installation-overview.md)
